...
//     Otherwise start looking around for a point equal or lesser height than this and run findBasin on it
//       because we know that it will be in the same basin as the current point.
//       (if it's not a lowpoint and not a ridge, then it must have a neighbor that isn't higher than it than it)
